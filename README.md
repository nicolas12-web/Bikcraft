...
Layouts modernos utilizando Flexbox

Organização avançada de layouts com CSS Grid

Criação de páginas responsivas utilizando Media Queries

Uso de boas práticas e atalhos para um código mais limpo e organizado
